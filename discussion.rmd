...
Multianalite assays enable xxx and yyy, which is great for reason x, y, and z. 
However, the extent and type of available analyties provides an inherrent limitation to applications based on multianaltyes assays.  To overcome this limitation, CMap developed L1000 an assay that does xxxx. The algorithm D-peak is based on k-means algorithm, a general and flexible tool to conduct non-parametric regression that is very popular in biology, as well as in many other fields. 
