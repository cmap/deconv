...
To evaluate the submissions, we developed a scoring function based on a combination of two different accuracy metrics; the Spearman rank correlation between the values and the ground truth and the area under the receiver operating curve (ROC) as a measure of aggregated classification performance in the prediction of extreme modulated genes. The scoring function also included the computational speed. (See \nameref{s1-appendix} for the details.)
