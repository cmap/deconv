...
```{r}
# example - extract just the ground truth data (columns)
gt_ds <- subset.gct(ds, cid=which(ds@cdesc$handle=="ground-truth"))
# and plot histogram of expression values
hist(gt_ds@mat)
```
...
boxplot(list(
  low_prop = gt_ds@mat[row_groups[[1]], ],
  high_prop = gt_ds@mat[row_groups[[2]], ]
), ylab="raw expression")
```
...
## Clustering gene-level correlations
