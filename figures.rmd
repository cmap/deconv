...
# high <- comp_roc(ds_uni_auc, ds_gardn999_auc, type = "high")
# low <- comp_roc(ds_uni_auc, ds_gardn999_auc, type = "low")
# high.bench <- comp_roc(ds_uni_auc, ds_bench_auc, type = "high")
# low.bench <- comp_roc(ds_uni_auc, ds_bench_auc, type = "low")
```

```{r auc-plots, cache = TRUE, echo = FALSE, fig.width = 7.1, fig.height = 7, fig.cap = cap}
cap <- "ROC, AUC and KD detection."
# Plot params
...
```{r best_algo_per_gene_bar, include = FALSE}
