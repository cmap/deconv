...
# TODO: better caption
cap <- "\\label{tsne_figure}t-SNE projection of holdout data. Each point represents the 2D projection of a sample generated by UNI ground truth (GT) or applying one of the deconvolution algorithms to DUO data. DECONV data colored by perturbagen type (A) and algorithm type (B). DECONV (C) and DE (D) data colored by algorithm type and stratified by each individual implementation."
