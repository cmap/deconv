...
Agreement between experimental replicates is crucial xxx [ref]  "The inter-replicate variation of gene expression-quantities is of the utmost importance to biologists because lower variance means higher reproducibility." [refXXX]. Our data contain several replicates which enabled us to study improvements in inter-replicability variance.   See figure \Fig{inter-replicate-variance}. 
