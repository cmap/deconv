...
We tested the accuracy and speed of the competitors' solutions by applying their algorithms to the DUO holdout data (two genes per bead color) and comparing to the equivalent UNI data (one gene per bead color) as ground truth.
