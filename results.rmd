...
The winning approach, developed by `gardn999`, was a random forest algorithm that combined the predictions of 10 different trees. Each tree was trained using 60 different features of the data. These features included the actual distribution of the values for each bead type (binned into 50 different variables), as well as various plate- and experiment-level variables for which the data point belongs. 

The second best appraoach, 
